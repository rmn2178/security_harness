 ...
 */
export interface NOSIHGatewayLike {
...
/**
 * SEP-1763-style request shape adapted into a NOSIH gateway call.
 */
 ...
 * while still preserving the raw NOSIH PolicyDecision for richer handling.
 */
...
export interface GuardedExecutionOptions<Result = unknown> {
  ...
  /**
   * Executes the downstream operation once the NOSIH decision and gate prerequisite allow it.
   */
...
export interface NOSIHPDPInterceptorConfig {
  readonly gateway: NOSIHGatewayLike;
