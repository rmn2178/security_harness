/**
 * NOSIH Client SDK — Gateway Client.
 *
 * Typed HTTP client for the NOSIH Gateway Server API.
 *
 * @module @nosih/client/nosih-client
 */
...
export interface NosihClientOptions {
...
export class NosihClient {
  ...
  constructor(options: NosihClientOptions) {
