#[cfg(test)]
mod tests {
    use nosih_client::types::*;
    use nosih_client::{RetryConfig, NosihRequestBuilder};
    ...
    #[test]
    fn test_nosih_request_serialization() {
        let req = NosihRequest {
    ...
    fn test_builder_builds_valid_request() {
        let req = NosihRequestBuilder::new()
    ...
    fn test_builder_auto_generates_request_id() {
        let req1 = NosihRequestBuilder::new()
            .agent_id("a")
            .token_id("t")
            .resource("r")
            .action("act")
        ...
        let req2 = NosihRequestBuilder::new()
            .agent_id("a")
            .token_id("t")
            .resource("r")
            .action("act")
    ...
    fn test_builder_missing_required_field_errors() {
        // Missing agent_id
        let result = NosihRequestBuilder::new()
            .token_id("t")
            .resource("r")
            .action("act")
            .build();
    ...
    fn test_builder_default() {
        ...
        let result = NosihRequestBuilder::default()
            .agent_id("a")
            .token_id("t")
            .resource("r")
            .action("act")
    ...
    async fn test_retry_succeeds_on_first_try() {
        use nosih_client::retry::{with_retry, RetryConfig};
