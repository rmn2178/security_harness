"""
NOSIH Protocol — OpenAI Agents runtime wrapper helpers.

Small execution helpers that compose:
- NOSIH authorization (`OpenAIAgentsGovernanceAdapter`)
...
from .types import PolicyDecision, NosihRequest
...
async def governed_tool_call(
    ...
    *,
    ...
    (`NosihDeniedError`, `NosihApprovalRequiredError`, etc.) for fail-closed control.
    """
