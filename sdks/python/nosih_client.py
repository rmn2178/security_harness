"""Python SDK for NOSIH Gateway v0.2.
...
class NosihClient:
    ...
    def _request(self, method: str, path: str, payload: Optional[Any] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            raise RuntimeError(f"NOSIH gateway request failed ({exc.code}): {message}") from exc

    def discovery(self) -> Dict[str, Any]:
        return self._request("GET", "/.well-known/nosih.json")
