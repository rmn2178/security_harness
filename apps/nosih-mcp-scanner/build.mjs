/**
 * esbuild bundle script for @nosih/mcp-scanner.
 * Produces self-contained dist/cli.js and dist/scanner.js with all
 * workspace dependencies inlined — no external @nosih/* deps at runtime.
 */
import * as esbuild from "esbuild";
import * as fs from "fs";

// CLI bundle — self-contained for `npx nosih-scan`
