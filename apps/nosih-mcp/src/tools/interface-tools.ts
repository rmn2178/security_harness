/**
 * NOSIH MCP — Operator Interface Tools.
 *
 ...
 * All tools are prefixed with "nosih__" and handled without policy enforcement
 * (they are operator-facing, not agent-facing actions).
 *
 * @module @nosih/mcp/tools/interface-tools
 */
...
/** Extended NOSIH tool context for interface tools. */
  ...
  return [
    ...
    },
    {
      ...
      inputSchema: {
          ...
          action: {
            ...
            properties: {
              ...
              tool: {
                ...
                examples: ["nosih__pending", "nosih__approve"],
              },
              args: {
        ...
        required: ["message"],
        additionalProperties: false,
        examples: [{ message: "Approval queue has blocked actions", action: { label: "Review approvals", tool: "nosih__pending", args: {} } }],
      },
      annotations: { title: "Send Notification", destructiveHint: false, idempotentHint: false, openWorldHint: false },
    },
    {
      name: "nosih__interface_mode",
      description:
