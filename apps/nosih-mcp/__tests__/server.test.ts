/**
 * NOSIH MCP — Server integration tests.
 */

import { describe, it, expect, beforeEach, afterEach } from "vitest";
import { NosihMCPServer } from "../src/server.js";
import type { NosihMCPConfig } from "../src/config.js";
import { Client } from "@modelcontextprotocol/sdk/client/index.js";

const defaultConfig: NosihMCPConfig = {
  servers: {},
...
describe("NosihMCPServer", () => {
  let server: NosihMCPServer;

  beforeEach(() => {
    server = new NosihMCPServer(defaultConfig);
  });
  ...
  it("initializes NOSIH components", () => {
