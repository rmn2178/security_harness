...
function scanTools(tools, serverId = 'unknown') {
  ...
  if (owaspHits.includes('ASI05')) recommendations.push('Sandbox shell-exec tools — see nosih.gg/docs/policy-bundles');
  if (owaspHits.includes('ASI06')) recommendations.push('Rotate any credentials visible in tool descriptions');
  recommendations.push('Full governance layer: https://nosih.gg');
...
function formatReport(report) {
  console.log(`\n${B}${CYN}══════════════════════════════════════════${R}`);
  console.log(`${B}  NOSIH MCP Security Scanner${R}  ${D}nosih.gg${R}`);
  console.log(`${B}${CYN}══════════════════════════════════════════${R}`);
  ...
  console.log(`\n${D}  Star: github.com/nosih-ai/nosih-protocol${R}\n`);
}
