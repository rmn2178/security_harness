#!/usr/bin/env node
// nosih-scan v0.1.0 — NOSIH Labs
// Scan any MCP server for risky tools in seconds
// https://nosih.gg | Apache-2.0
...
function printUsage() {
  console.log(`\n${BOLD}nosih-scan${RESET} — MCP Server Security Scanner by NOSIH Protocol\n`);
  ...
  console.log(`  ${DIM}Full governance: https://nosih.gg${RESET}\n`);
}
